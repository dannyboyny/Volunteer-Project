...
?>
    ...
    <section id="error" class="container text-center"> <!--Eventos recomendados -->
        <h1>Página de Eventos Recomendados</h1>
        <p>Esta es la página de eventos recomendados.</p>
